...
// Get all projects (filter by user for non-admin)
...
// Update project (with proper permission check)
...
// Delete project (with proper permission check)
...
// Delete entire session (with proper permission check)
...
// Generate share link (with proper permission check)
...
// Update session notes (with proper permission check)
...
// Update file name (with proper permission check)
...
// Update file name via share link
...
// Delete file (with permission checks for shared projects)
...
// Get single file (with permission check)
...
// Download file from project with format conversion (with permission check)
...
// Bulk download files with format options (with permission check)
